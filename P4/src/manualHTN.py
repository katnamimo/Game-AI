...
pyhop.declare_operators (op_punch_for_wood, op_craft_plank, op_craft_bench, op_craft_stick, op_craft_wooden_axe_at_bench, op_wooden_axe_for_wood)
...
#pyhop.pyhop(state, [('have_enough', 'agent', 'plank', 1)], verbose=2)
# pyhop.pyhop(state, [('have_enough', 'agent', 'bench', 1)], verbose=2)
#pyhop.pyhop(state, [('have_enough', 'agent', 'stick', 1)], verbose=2)
#pyhop.pyhop(state, [('have_enough', 'agent', 'wooden_axe', 1)], verbose=2)
# '''
